...
.|.| LAYING
||
3 | Feature | The name of the time or frequency variable for whom the mean or std deviation was calculated in the original data set.  The following are the relevant variables - 79 per Subject-Activity pair.
